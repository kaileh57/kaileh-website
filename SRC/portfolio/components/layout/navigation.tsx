    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black/90 backdrop-blur-sm border-b border-gray-800">
      <div className="max-w-6xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          <a href="#" className="font-bold text-lg md:text-xl text-white flex items-center gap-2">
            <span className="bg-white text-black px-2 py-1 rounded text-sm font-mono">KH</span>
            <span className="hidden sm:inline">Kellen Heraty</span>
          </a>
